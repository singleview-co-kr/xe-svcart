...
function load_cart() {
	...
	exec_xml('svorder', 'getSvorderCartItems', params, function(ret_obj) {
...
function load_favorites() {
	var params = new Array();
	var response_tags = new Array('error','message','data','mileage');
	exec_xml('svorder', 'getSvorderFavoriteItems', params, function(ret_obj) { 
...
function delete_cart() {
	...
	exec_xml('svorder', 'procSvorderDeleteCart', params, completeDeleteItems, responses);
}
...
function delete_favorites() {
	...
	var responses = ['error','message'];
	exec_xml('svorder', 'procSvorderDeleteFavoriteItems', params, completeDeleteItems, responses);
}
...
function goto_order(login_chk) {
	...
	*/
	...
	if(login_chk == "Y")
	{
		var url = current_url.setQuery('act','dispSvorderOrderItems');
		location.href=url;
	}
	else
	{
		var url = current_url.setQuery('act','dispSvorderLogin');
		location.href=url;
	}
}
